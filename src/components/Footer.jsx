                ...
                <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    <div className="md:flex md:justify-between">
                        ...
                        <div className="grid grid-cols-2 gap-8 sm:gap-12 sm:grid-cols-4">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-400 font-medium text-opacity-85">
                                    <li className="mb-4">
                                        <a href="https://www.davivienda.com.sv/#/personas/personas_legal" className="hover:underline">Politicas de privacidad</a>
                                    </li>
                                    <li>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="flex mt-4 sm:justify-center sm:mt-0">
                            <a href="https://www.facebook.com/DaviviendaElSalvador/?locale=es_LA" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                            ...
                            <a href="https://twitter.com/daviviendasalv?lang=es" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
