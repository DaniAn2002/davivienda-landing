const Fechas = () => {
    return (
        <section>
            ...
            <div className="bg-[#DC2626] xl:p-4">
                <section className="xl:border xl:border-davivienda-smoke xl:rounded-2xl xl:p-2 text-white max-w-screen-xl mx-auto">
                    <div className="flex flex-col md:flex-row justify-between items-center max-w-screen-xl">
                        <div className="hidden md:block md:w-1/2 my-2">
                            <img src="https://res.cloudinary.com/dyhftwfrw/image/upload/v1708971274/davi/xeroq7cuhoqj4oknekmr.jpg" alt="Hero Image" className="md:angled-mask drop-shadow-lg md:w-[500px] sm:w-[300px]" />
                        </div>
                        <div className="mb-2 mx-2 md:w-1/2 2xl:my-0">
                            <div className="relative grid grid-cols-1 mx-auto text-cyan-950 w-[calc(290px+8vw)] min-[400px]:w-[calc(375px+5vw)] md:w-full md:max-w-[400px]">
                                <img className="absolute self-center justify-self-center h-[84.5%] pb-4" src="https://res.cloudinary.com/dk2oxzxoo/image/upload/v1709031663/kodigo-Davivienda/Line_clean_sfzc5d.png" alt="" />
                                <div className="grid items-center my-4">
                                    <div className="bg-davivienda-smoke rounded-2xl w-[calc(128px+5vw)] p-4 md:w-[165px]">
                                ...
                                <div className="grid items-center my-4">
                                    <div className="bg-davivienda-smoke rounded-2xl w-[calc(128px+5vw)] p-4 md:w-[165px] justify-self-end">
                                ...
                                <div className="grid items-center my-4">
                                    <div className="bg-davivienda-smoke rounded-2xl w-[calc(128px+5vw)] p-4 md:w-[165px] justify-self-end">
                                        <h2 className="text-lg font-bold underline md:text-xl">Primer Filtro</h2>
                                        <span className="block text-sm md:text-base">Virtual</span>
                                        <p className="text-sm italic md:text-base">13 - 14 MAY</p>
                                        <p className="font-semibold">Selección <span className="block">de equipos</span></p>
                                    </div>
                                    <div className="absolute w-[18px] h-[18px] bg-[#F78E20] border border-davivienda-smoke rounded-full justify-self-center">
                                    </div>
                                </div>
                    ...
                    <div className="bg-[#DC2626] p-1 pb-4 2xl:pt-3 max-w-screen-xl">
                        <div className="bg-davivienda-red border border-davivienda-smoke rounded-[20px] drop-shadow-lg  w-full mx-auto p-4 max-w-screen-sm lg:max-w-screen-md">
                            <div className="bg-fake-white text-cyan-950 rounded-xl mb-6 mx-2 p-2 2xl:mb-12">
                            ...
                            <div className="flex flex-wrap flex-row justify-center items-center">
                                ...
                                <div className="justify-center items-center">
                                    <h1 className="rounded-full font-bold text-6xl text-center text-white p-10 drop-shadow-lg">
                                        de Mayo
                                    </h1>
                                </div>
                            </div>
