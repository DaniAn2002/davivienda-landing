const MainHero = () => {
  return (
    <section id="home" style={{ marginTop: '4.5rem' }} className="flex flex-wrap justify-between items-center relative max-w-[1280px] mb-10 mx-4 md:justify-evenly md:mx-auto lg:justify-around">
