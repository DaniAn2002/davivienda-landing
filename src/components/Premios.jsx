...
export const Premios = () => {
    return (
        ...
        <div className=" md:w-1/2 mb-10 md:mb-0">
            <h2 className="text-4xl font-bold leading-tight mb-4 text-center drop-shadow-lg pt-10">Tres dias de hacking intenso!</h2>
            <div className="flex flex-wrap flex-row justify-center items-center">
            <h1 className="rounded-full font-bold text-6xl text-white text-center  flex items-center justify-center w-32 h-32 p-10 bg-white border border-gray-200 drop-shadow-lg hover:bg-red-100 dark:bg-red-700 dark:border-red-700 dark:hover:bg-red-700 mx-auto my-4">
                    17
                </h1>
            <h1 className="rounded-full font-bold text-6xl text-white text-center  flex items-center justify-center w-32 h-32 p-10 bg-white border border-gray-200 drop-shadow-lg hover:bg-red-100 dark:bg-red-700 dark:border-red-700 dark:hover:bg-red-700 mx-auto my-4">
                    18
